...
create_ui (CustomData *data)
{
  ...
  play_button = gtk_button_new_from_icon_name (
...
main (int argc, char *argv[])
{
  ...
  g_signal_connect (
      G_OBJECT (data.playbin), "video-tags-changed", (GCallback)tags_cb, &data);
  g_signal_connect (
      G_OBJECT (data.playbin), "audio-tags-changed", (GCallback)tags_cb, &data);
  ...
  g_signal_connect (
      G_OBJECT (bus), "message::application", (GCallback)application_cb, &data);
